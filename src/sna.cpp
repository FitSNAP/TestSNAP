...
void SNA::compute_ui() {
    ...
    parallel_for(
        policy_ui, KOKKOS_CLASS_LAMBDA(const member_type team_member) {
            parallel_for(
                TeamThreadRange(team_member, ui_team_size),
                [&](const int not_using) {
                    int iter =
                    ...
                    if (iter < nTotal) {
                        ...
                        ScratchViewType buf1(
                            team_member.team_scratch(scratch_level),
        ...
        num_atoms * idxz_max, KOKKOS_CLASS_LAMBDA(const int iter) {
            ...
            for (int ib = 0; ib < nb; ib++) {
                ...
                for (int ia = 0; ia < na; ia++) {
                    suma1_r +=
                        cgblock[icga] * (ulisttot(jju1 + ma1, natom).re *
...
void SNA::compute_fused_deidrj() {
    ...
    policy_du =
        policy_du.set_scratch_size(scratch_level, PerTeam(scratch_size));

    parallel_for(
        policy_du, KOKKOS_CLASS_LAMBDA(const member_type team_member) {
            parallel_for(
                TeamThreadRange(team_member, du_team_size),
                [&](const int not_using) {
                    int iter =
                        team_member.league_rank() * team_member.team_size() +
                        team_member.team_rank();
                            ...
                            for (int j = 1; j <= twojmax; j++) {
                                ...
                                parallel_for(
                                    ...
                                    [&](const int m_iter) {
                                        ...
                                        ubuf1[buf1_index].re +=
                                            -rootpq *
                                            (b_r * ubuf2[buf2_index].re +
                                             b_i * ubuf2[buf2_index].im);
                                        ubuf1[buf1_index].im +=
                                            -rootpq *
                                            (b_r * ubuf2[buf2_index].im -
                                ...
                                parallel_for(
                                    ...
                                    [&](const int m_iter) {
                                        ...
                                        ubuf1[buf1_index].re +=
                                            rootpq *
                                            (a_r * ubuf2[buf2_index].re +
                                             a_i * ubuf2[buf2_index].im);
                                        ubuf1[buf1_index].im +=
                                            rootpq *
                                            (a_r * ubuf2[buf2_index].im -
                                ...
                                if (j % 2 == 0) {
                                    ...
                                    parallel_for(
                                        ...
                                        [&](const int ma) {
                                            ...
                                            ubuf1[buf1_index].re +=
                                                rootpq *
                                                (a_r * ubuf2[ubuf2_index - ma]
                                                           .re +
                                                 a_i * -ubuf2[ubuf2_index - ma]
                                                            .im);
                                            ubuf1[buf1_index].im +=
                                                rootpq *
                                                (a_r * -ubuf2[ubuf2_index - ma]
                                    ...
                                    parallel_for(
                                        ...
                                        [&](const int ma) {
                                            ...
                                            ubuf1[buf1_index + 1].re +=
                                                -rootpq *
                                                (b_r * ubuf2[ubuf2_index - ma]
                                                           .re +
                                                 b_i * -ubuf2[ubuf2_index - ma]
                                                            .im);
                                ...
                                parallel_for(
                                    ...
                                    [&](const int m_iter) {
                                        ...
                                        buf1[buf_index].re =
                                            dsfac * ubuf2[ubuf_index].re *
                                                u[k] +
                                            sfac * buf2[buf_index].re;
                                        buf1[buf_index].im =
                                            dsfac * ubuf2[ubuf_index].im *
                                                u[k] +
